...
public class MoneyUtils {
    static final int[] moneyUnit = {1, 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000};
     ...
     * @date:  2021年8月7日
     */
    public static String getFormatMoney(BigDecimal money, int scale, int divisor) {
     ...
     * @date:  2021年8月7日
     */
    public static String getAccountantMoney(BigDecimal money, int scale, int divisor) {
     ...
     * @date:  2021年8月7日
     */
    private static String accountantMoney(BigDecimal money, int scale, int divisor) {
     ...
     * @date:  2021年8月7日
     */
    private static String formatMoney(BigDecimal money, int scale, int divisor) {
        if (divisor == 0) {
            return "0.00";
        }
        if (scale < 0) {
        ...
        BigDecimal divisorBD = new BigDecimal(moneyUnit[divisor]);
     ...
     * @return
     */
    private static String getCellFormat(int divisor) {
        String cell = "";
        switch (divisor) {
            case 1:
                cell = "元";
